 ...
 */
public class EstadoDeEmpleado extends javax.swing.JFrame {
Connection conn=null;
ResultSet rs=null;
PreparedStatement pst=null;
    /**
     * Creates new form EstadoDeEmpleado
     */
    public EstadoDeEmpleado() {
        initComponents();
   ...
   size.height/2 - getHeight()/2);
    ...
    private void txt_searchKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txt_searchKeyReleased
        ...
        try{
            ...
            String sql ="select * from EstadoEmpleado where id=? ";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EstadoDeEmpleado.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new EstadoDeEmpleado().setVisible(true);
            }
        });
    }
